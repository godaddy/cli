...
use crate::platform::app::onboarding::ensure_ready_for_app_init;
...
async fn handle_from_existing(
    ...
    // already exists; this command only syncs identity, version, and webhook
    // subscriptions, not the whole manifest.
